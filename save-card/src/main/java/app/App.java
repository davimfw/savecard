...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("\n\n==== Inserir usuário === ");
		Usuario usuario = new Usuario(11, "pablo", "pablo@email.com" ,"pablo");
		if(usuarioDAO.insert(usuario) == true) {
			System.out.println("Inserção com sucesso -> " + usuario.toString());
		}
		
		System.out.println("\n\n==== Testando autenticação ===");
		System.out.println("Usuário (" + usuario.getEmail() + "): " + usuarioDAO.autenticar("pablo", "pablo"));
		...
		System.out.println("\n\n==== Testando autenticação ===");
		System.out.println("Usuário (" + usuario.getEmail() + "): " + usuarioDAO.autenticar("pablo", DAO.toMD5("pablo")));		
		
		System.out.println("\n\n==== Invadir usando SQL Injection ===");
		System.out.println("Usuário (" + usuario.getEmail() + "): " + usuarioDAO.autenticar("pablo", "x' OR 'x' LIKE 'x"));
